        ...
        <div class="col-main">
          <div class="product-view-area">
            <div class="product-big-image col-xs-12 col-sm-5 col-lg-5 col-md-5">
              <div class="icon-sale-label sale-left">Sale</div>
              <div class="large-image"><a href="images/product-1.jpg" class="cloud-zoom" id="magni_img" data-big="images/product-1.jpg" data-overlay="images/magnifying_glass.png" rel="useWrapper: false, adjustY:0, adjustX:20"> <img  src="images/product-1.jpg" alt="pr img"/></a> </div>
              <div class="flexslider flexslider-thumb">
                <ul class="previews-list slides">
                  <li><a href='images/product-1.jpg' class='cloud-zoom-gallery' rel="useZoom: 'magni_img', smallImage: 'images/product-1.jpg' "><img src="images/product-1.jpg" alt = "Thumbnail 2"/></a></li>
                  <li><a href='images/product-1a.jpg' class='cloud-zoom-gallery' rel="useZoom: 'magni_img', smallImage: 'images/product-1a.jpg' "><img src="images/product-1a.jpg" alt = "Thumbnail 1"/></a></li>
                  <li><a href='images/product-1b.jpg' class='cloud-zoom-gallery' rel="useZoom: 'magni_img', smallImage: 'images/product-1b.jpg' "><img src="images/product-1b.jpg" alt = "Thumbnail 1"/></a></li>
                  <li><a href='images/product-1c.jpg' class='cloud-zoom-gallery' rel="useZoom: 'magni_img', smallImage: 'images/product-1c.jpg' "><img src="images/product-1c.jpg" alt = "Thumbnail 2"/></a></li>
                  <li><a href='images/product-1d.jpg' class='cloud-zoom-gallery' rel="useZoom: 'magni_img', smallImage: 'images/product-1d.jpg' "><img src="images/product-1d.jpg" alt = "Thumbnail 2"/></a></li>
                </ul>
              </div>
...
<script src="js/jquery.magnifying-zoom.js"></script>
