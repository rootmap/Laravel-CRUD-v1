        ...
        <div class="col-main col-sm-9 col-xs-12">
          <div class="product-view-area">
            <div class="product-big-image col-xs-12 col-sm-5 col-lg-5 col-md-5">
              <div class="icon-sale-label sale-left">Sale</div>
              <div class="large-image"><a href="images/product-3.jpg" class="cloud-zoom" id="zoom1" rel="useWrapper: false, adjustY:0, adjustX:20"> <img class="zoom-img" src="images/product-3.jpg" alt="products"> </a> </div>
              <div class="flexslider flexslider-thumb">
                <ul class="previews-list slides">
                  <li><a href='images/product-1.jpg' class='cloud-zoom-gallery' rel="useZoom: 'zoom1', smallImage: 'images/product-1.jpg' "><img src="images/product-1.jpg" alt = "Thumbnail 2"/></a></li>
                  <li><a href='images/product-1a.jpg' class='cloud-zoom-gallery' rel="useZoom: 'zoom1', smallImage: 'images/product-1a.jpg' "><img src="images/product-1a.jpg" alt = "Thumbnail 1"/></a></li>
                  <li><a href='images/product-1b.jpg' class='cloud-zoom-gallery' rel="useZoom: 'zoom1', smallImage: 'images/product-1b.jpg' "><img src="images/product-1b.jpg" alt = "Thumbnail 1"/></a></li>
                  <li><a href='images/product-1c.jpg' class='cloud-zoom-gallery' rel="useZoom: 'zoom1', smallImage: 'images/product-1c.jpg' "><img src="images/product-1c.jpg" alt = "Thumbnail 2"/></a></li>
                  <li><a href='images/product-1d.jpg' class='cloud-zoom-gallery' rel="useZoom: 'zoom1', smallImage: 'images/product-1d.jpg' "><img src="images/product-1d.jpg" alt = "Thumbnail 2"/></a></li>
                </ul>
              </div>
            ...
            <div class="col-xs-12 col-sm-7 col-lg-7 col-md-7 product-details-area">
              ...
              <div class="short-description">
                ...
                <p>Lorem ipsum dolor sit amet, consectetur adipiscing elit.Donec non est at libero vulputate rutrum.
                <p> Vivamus adipiscing nisl ut dolor dignissim semper. Class aptent taciti sociosqu ad litora torquent per conubia nostra.</p>
              </div>
        ...
        <aside class="right sidebar col-sm-3 col-xs-12">
          ...
          <div class="block special-product">
            ...
            <div class="block-content">
              <ul>
                <li class="item">
                  <div class="products-block-left"><a href="single_product.php" title="Sample Product" class="product-image"><img src="images/product-1.jpg" alt="Sample Product "></a></div>
                ...
                <li class="item">
                  <div class="products-block-left"><a href="single_product.php" title="Sample Product" class="product-image"><img src="images/product-2.jpg" alt="Sample Product "></a></div>
                  <div class="products-block-right">
                ...
                <li class="item">
                  <div class="products-block-left"><a href="single_product.php" title="Sample Product" class="product-image"><img src="images/product-5.jpg" alt="Sample Product "></a></div>
                  <div class="products-block-right">
                    <p class="product-name"><a href="single_product.php">Consectetur utes anet adipisicing elit</a> </p>
                ...
                <div class="slider-items slider-width-col4 fadeInUp">
                  <div class="product-item">
                    <div class="item-inner">
                      <div class="product-thumbnail">
                        <div class="pr-img-area"> <a title="Product title here" href="single_product.php">
                          <figure> <img class="first-img" src="images/product-11.jpg" alt="HTML template"> <img class="hover-img" src="images/product-6.jpg" alt="HTML template"></figure>
                          </a> </div>
                        <div class="pr-info-area">
                          <div class="pr-button">
                  ...
                  <div class="product-item">
                    <div class="item-inner">
                      <div class="product-thumbnail">
                        ...
                        <div class="icon-new-label new-right">New</div>
                        <div class="pr-img-area"> <a title="Product title here" href="single_product.php">
                          <figure> <img class="first-img" src="images/product-15.jpg" alt="HTML template"> <img class="hover-img" src="images/product-3.jpg" alt="HTML template"></figure>
                          </a> </div>
                        <div class="pr-info-area">
                          <div class="pr-button">
                            <div class="mt-button add_to_wishlist"><a href="wishlist.php"> <i class="fa fa-heart-o"></i> </a> </div>
                  ...
                  <div class="product-item">
                    <div class="item-inner">
                      <div class="product-thumbnail">
                        <div class="pr-img-area"> <a title="Product title here" href="single_product.php">
                          <figure> <img class="first-img" src="images/product-17.jpg" alt="HTML template"> <img class="hover-img" src="images/product-4.jpg" alt="HTML template"></figure>
                          </a> </div>
                        <div class="pr-info-area">
                          <div class="pr-button">
                            <div class="mt-button add_to_wishlist"><a href="wishlist.php"> <i class="fa fa-heart-o"></i> </a> </div>
                  ...
                  <div class="product-item">
                    <div class="item-inner">
                      <div class="product-thumbnail">
                        <div class="pr-img-area"> <a title="Product title here" href="single_product.php">
                          <figure> <img class="first-img" src="images/product-11.jpg" alt="HTML template"> <img class="hover-img" src="images/product-5.jpg" alt="HTML template"></figure>
                          </a> </div>
                        <div class="pr-info-area">
                          <div class="pr-button">
                            <div class="mt-button add_to_wishlist"><a href="wishlist.php"> <i class="fa fa-heart-o"></i> </a> </div>
                  ...
                  <div class="product-item">
                    <div class="item-inner">
                      <div class="product-thumbnail">
                        <div class="pr-img-area"> <a title="Product title here" href="single_product.php">
                          <figure> <img class="first-img" src="images/product-8.jpg" alt="HTML template"> <img class="hover-img" src="images/product-2.jpg" alt="HTML template"></figure>
                          </a> </div>
                        <div class="pr-info-area">
                          <div class="pr-button">
                            <div class="mt-button add_to_wishlist"><a href="wishlist.php"> <i class="fa fa-heart-o"></i> </a> </div>
                  ...
                  <div class="product-item">
                    <div class="item-inner">
                      <div class="product-thumbnail">
                        <div class="pr-img-area"> <a title="Product title here" href="single_product.php">
                          <figure> <img class="first-img" src="images/product-13.jpg" alt="HTML template"> <img class="hover-img" src="images/product-4.jpg" alt="HTML template"></figure>
                          </a> </div>
                        <div class="pr-info-area">
                          <div class="pr-button">
                            <div class="mt-button add_to_wishlist"><a href="wishlist.php"> <i class="fa fa-heart-o"></i> </a> </div>
                  ...
                  <div class="product-item">
                    <div class="item-inner">
                      <div class="product-thumbnail">
                        <div class="pr-img-area"> <a title="Product title here" href="single_product.php">
                          <figure> <img class="first-img" src="images/product-15.jpg" alt="HTML template"> <img class="hover-img" src="images/product-8.jpg" alt="HTML template"></figure>
                          </a> </div>
                        <div class="pr-info-area">
                          <div class="pr-button">
                            <div class="mt-button add_to_wishlist"><a href="wishlist.php"> <i class="fa fa-heart-o"></i> </a> </div>
                  ...
                  <div class="product-item">
                    <div class="item-inner">
                      <div class="product-thumbnail">
                        <div class="pr-img-area"> <a title="Product title here" href="single_product.php">
                          <figure> <img class="first-img" src="images/product-16.jpg" alt="HTML template"> <img class="hover-img" src="images/product-6.jpg" alt="HTML template"></figure>
                          </a> </div>
                        <div class="pr-info-area">
                          <div class="pr-button">
                            <div class="mt-button add_to_wishlist"><a href="wishlist.php"> <i class="fa fa-heart-o"></i> </a> </div>
                ...
                <div class="product-item">
                  <div class="item-inner">
                    <div class="product-thumbnail">
                      <div class="icon-sale-label sale-left">Sale</div>
                      <div class="pr-img-area"> <a title="Product title here" href="single_product.php">
                        <figure> <img class="first-img" src="images/product-12.jpg" alt="HTML template"> <img class="hover-img" src="images/product-9.jpg" alt="HTML template"></figure>
                        </a> </div>
                      <div class="pr-info-area">
                        <div class="pr-button">
                          <div class="mt-button add_to_wishlist"><a href="wishlist.php"> <i class="fa fa-heart-o"></i> </a> </div>
