    ...
    <div class="main container">
      <div class="typography-wrapper">
        <div class="my-account">
          ...
          <div class="row">
            <div class="col-sm-4 col-md-4 col-xs-12">
              <h4 class="text-uppercase">Headings Uppercase<br>
                <small><code>text-uppercase</code></small></h4>
            ...
            <div class="col-md-4 col-sm-4 col-xs-12">
              <h4 class="text-capitalize">Headings Capitalize<br>
                <small><code>text-capitalize</code></small></h4>
              <h1 class="text-capitalize">Heading 1</h1>
              <h2 class="text-capitalize">Heading 2</h2>
              <h3 class="text-capitalize">Heading 3</h3>
              <h4 class="text-capitalize">Heading 4</h4>
              <h5 class="text-capitalize">Heading 5</h5>
              <h6 class="text-capitalize">Heading 6</h6>
            </div>
            <div class="col-md-4 col-sm-4 col-xs-12">
              <h4 class="text-lowercase">Headings Lowercase<br>
                <small><code>text-lowercase</code></small></h4>
              <h1 class="text-lowercase">Heading 1</h1>
              <h2 class="text-lowercase">Heading 2</h2>
              <h3 class="text-lowercase">Heading 3</h3>
              <h4 class="text-lowercase">Heading 4</h4>
              <h5 class="text-lowercase">Heading 5</h5>
              <h6 class="text-lowercase">Heading 6</h6>
            </div>
          </div>
          <div class="row">
            <div class="col-md-4 col-sm-4 col-xs-12">
              <h1 class="text-uppercase color-template">Heading 1<small>Secondary Text</small></h1>
              <h2 class="text-uppercase color-red">Heading 2<small>Secondary Text</small></h2>
              <h3 class="text-uppercase color-pink">Heading 3<small>Secondary Text</small></h3>
              <h4 class="text-uppercase color-orange">Heading 4<small>Secondary Text</small></h4>
              <h5 class="text-uppercase color-purple">Heading 5<small>Secondary Text</small></h5>
              <h6 class="text-uppercase color-blue">Heading 6<small>Secondary Text</small></h6>
            </div>
            <div class="col-md-4 col-sm-4 col-xs-12">
              <h1 class="text-capitalize color-cyan">Heading 1<small>Secondary Text</small></h1>
              <h2 class="text-capitalize color-green">Heading 2<small>Secondary Text</small></h2>
              <h3 class="text-capitalize color-yellow">Heading 3<small>Secondary Text</small></h3>
              <h4 class="text-capitalize color-dark">Heading 4<small>Secondary Text</small></h4>
              <h5 class="text-capitalize color-dark2">Heading 5<small>Secondary Text</small></h5>
              <h6 class="text-capitalize color-gray">Heading 6<small>Secondary Text</small></h6>
            </div>
            <div class="col-md-4 col-sm-4 col-xs-12">
              <h1 class="text-lowercase color-blue">Heading 1<small>Secondary Text</small></h1>
              <h2 class="text-lowercase color-cyan">Heading 2<small>Secondary Text</small></h2>
              <h3 class="text-lowercase color-green">Heading 3<small>Secondary Text</small></h3>
              <h4 class="text-lowercase color-warning">Heading 4<small>Secondary Text</small></h4>
              <h5 class="text-lowercase color-success">Heading 5<small>Secondary Text</small></h5>
              <h6 class="text-lowercase color-danger">Heading 6<small>Secondary Text</small></h6>
            </div>
          </div>
          <div class="row">
            ...
            <div class="col-md-12 col-sm-12  col-xs-12">
              <h5>Full Width</h5>
              <p> <span class="dropcap color-orange">B</span>onec sed odio dui. <strong class="color-black">bold text with black color</strong> elit libero, a pharetra augue <code>code text</code> id nibh ultricies vehicula ut id elit<sub>subscript text</sub>. <em class="color-black">Italic Style </em>Integer posuere erat a ante venenatis <s>Strikethrough text</s> dapibus posuere velit aliquet. 
                Duis mollis, <span class="font-Ultima color-primary"> text Ultima</span>, <span class="font-open-sans color-success"> text open sans</span>, <span class="font-montserrat color-danger"> text montserrat</span> test non commodo luctus. <kbd>Ctrl + S</kbd> Aenean lacinia bibendum nulla sed consectetur. <span class="text-uppercase color-black">Text Uppercase </span> Cras mattis consectetur purus sit amet fermentum. Donec id elit non mi porta gravida at eget metus. Lorem ipsum dolor sit amet, 
                consectetur adipiscing elit. Vestibulum id ligula porta felis<a href="#">hyperlink </a>euismod semper. </p>
            </div>
            <div class="col-md-6 col-sm-6 col-xs-12">
              <h5>Half Width</h5>
              <p> <span data-toggle="tooltip" data-placement="top" title="tooltip text" class="color-black">ooltip Top</span> <span class="dropcap bg-Ultima color-blue">T</span>onec sed odio dui. Nulla vitae elit libero, <span data-toggle="tooltip" data-placement="right" title="tooltip text" class="color-black">Tooltip Right</span> a pharetra augue. <span data-toggle="tooltip" data-placement="bottom" title="tooltip text" class="color-black">Tooltip Bottom</span> Nullam id dolor id nibh ultricies vehicula ut id elit.                             
                Integer posuere erat a ante venenatis dapibus posuere velit aliquet. <span data-toggle="tooltip" data-placement="left" title="tooltip text" class="color-black">Tooltip Left</span> Duis mollis, est non commodo luctus. </p>
            </div>
            <div class="col-md-6 col-sm-6 col-xs-12">
              <h5>Half Width</h5>
              <p> <span class="color-primary">Donec sed odio</span> dui. Nulla vitae elit libero, <span class="color-success">a pharetra augue</span>. Nullam id dolor id nibh <span class="color-info">ultricies vehicula</span> ut id elit. 
                Integer posuere <span class="color-warning">erat a ante venenatis</span> dapibus posuere velit aliquet. <span class="color-danger">Duis mollis</span>, est non commodo luctus. <span class="color-custom">Donec sed odio dui</span>. Nulla vitae elit <span class="color-black">libero.</span> </p>
            </div>
            <div class="col-md-8 col-sm-8 col-xs-12">
              <h5>2/3 Width</h5>
              <p> Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam id dolor id nibh ultricies vehicula ut id elit. 
                Integer posuere erat a ante venenatis dapibus posuere velit aliquet. Duis mollis, est non commodo luctus. </p>
            </div>
            <div class="col-md-4 col-sm-4 col-xs-12">
              <h5>1/3 Width</h5>
              <p> Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nullam id dolor id nibh ultricies vehicula. </p>
            </div>
            ...
            <div class="col-md-2 col-sm-3 col-xs-12">
              <h5>1/6 Width</h5>
              <p> Donec sed odio dui. Nulla vitae elit. </p>
            </div>
          ...
          <div class="row">
            ...
            <div class="col-md-3 text-left col-xs-12">
              <h5>Text Left</h5>
