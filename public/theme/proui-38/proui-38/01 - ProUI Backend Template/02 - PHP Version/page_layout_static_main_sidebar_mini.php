<?php include 'inc/config.php'; $template['header'] = ''; $template['sidebar'] = 'sidebar-mini sidebar-visible-lg-mini sidebar-no-animations'; ?>
<?php include 'inc/template_start.php'; ?>
<?php include 'inc/page_head.php'; ?>

<!-- Page content -->
<div id="page-content">
    <!-- Mini Main Sidebar Header -->
    <div class="content-header">
        <div class="header-section">
            <h1>
                <i class="gi gi-show_big_thumbnails"></i>Mini Main Sidebar<br><small>Mini Sidebar with flyout menu (> 991px)</small>
            </h1>
        </div>
    </div>
    <ul class="breadcrumb breadcrumb-top">
        <li>Page Layouts</li>
        <li><a href="">Mini Main Sidebar</a></li>
    </ul>
    <!-- END Mini Main Sidebar Header -->
