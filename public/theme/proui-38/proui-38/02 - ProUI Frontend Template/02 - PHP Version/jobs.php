...
<section class="site-section site-section-light site-section-top themed-background-dark">
    <div class="container">
        <h1 class="text-center animation-slideDown"><i class="fa fa-check-square"></i> <strong>Find the service you need</strong></h1>
        <h2 class="h3 text-center animation-slideUp">Thousands of <strong>freelancers</strong> are waiting for <strong>you</strong>!</h2>
    </div>
</section>
<!-- END Intro -->
...
<section class="site-content site-section">
    <div class="container">
        <h2 class="site-heading"><strong>Featured</strong> Services</h2>
        <hr>
        ...
        <h2 class="site-heading"><strong>Most Recent</strong> Services</h2>
        <hr>
        <div class="row store-items">
            <div class="col-md-4 visibility-none" data-toggle="animation-appear" data-animation-class="animation-fadeInQuick" data-element-offset="-100">
                <a href="javascript:void(0)" class="store-item">
            ...
            <div class="col-md-4 visibility-none" data-toggle="animation-appear" data-animation-class="animation-fadeInQuick" data-element-offset="-100">
                <a href="javascript:void(0)" class="store-item">
                    ...
                    <div class="store-item-icon">
                        <i class="gi gi-iphone themed-color-autumn"></i>
                    </div>
                    <div class="store-item-info clearfix">
                        <span class="store-item-price themed-color-dark pull-right">$4500</span>
                        <strong>App Development</strong><br>
                        <span class="text-muted">from <strong>AppParadise</strong></span>
                    </div>
                </a>
            </div>
            <div class="col-md-4 visibility-none" data-toggle="animation-appear" data-animation-class="animation-fadeInQuick" data-element-offset="-100">
                <a href="javascript:void(0)" class="store-item">
                    ...
                    <div class="store-item-icon">
                        <i class="gi gi-more_windows themed-color-modern"></i>
                    </div>
                    <div class="store-item-info clearfix">
                        <span class="store-item-price themed-color-dark pull-right">$1800</span>
                        <strong>App Design</strong><br>
                        <span class="text-muted">from <strong>AppDeluxe</strong></span>
                    </div>
                </a>
            </div>
            <div class="col-md-4 visibility-none" data-toggle="animation-appear" data-animation-class="animation-fadeInQuick" data-element-offset="-100">
                <a href="javascript:void(0)" class="store-item">
                    ...
                    <div class="store-item-icon">
                        <i class="gi gi-server themed-color-night"></i>
                    </div>
                    <div class="store-item-info clearfix">
                        <span class="store-item-price themed-color-dark pull-right">$15</span>
                        <strong>Web Hosting</strong><br>
                        <span class="text-muted">from <strong>UltimateHost</strong></span>
                    </div>
                </a>
            </div>
            <div class="col-md-4 visibility-none" data-toggle="animation-appear" data-animation-class="animation-fadeInQuick" data-element-offset="-100">
