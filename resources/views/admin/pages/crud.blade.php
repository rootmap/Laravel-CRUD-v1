                            ...
                            <form class="text-center" action="{{route('crudgenarate')}}" method="post">
                                ...
                                <ul class="list-inline">
                                    <li class="list-inline-item">
                                        <button type="button" onclick="javascript:addmore();" class="btn"><i class="fas fa-plus"></i> Add More Field</button>
                                    </li>
                                    <li class="list-inline-item">
                                        <button type="submit" class="btn"><i class="fa fa-angle-right"></i> Submit</button>
                                    </li>
                                    <li class="list-inline-item">
