                    ...
                    <div class="box">
                        <div class="row no-gutters" style="border-bottom: 3px #fff solid;">
                            <div class="col text-left">
                                <div class="add-new">
                                    <a href="{{url('datapull/create')}}">Add New<i class="fas fa-plus"></i></a>
                                </div><!-- End add-new-->
                            </div><!-- End column-->
                            <div class="col">
                                <div class="heading-messages">
                                    <h3 class="text-center">data pull Listing</h3>
                                ...
                                @if(count($dataRow))
                                    @foreach($dataRow as $row)  
                                        <tr><td class="text-center">{{$row->id}}</td><td class="text-center">{{$row->name}}</td>
                                            ...
                                            <td>
                                                <a href="{{url('datapull/edit/'.$row->id)}}"><i class="fas fa-edit"></i></a>
                                                <a href="{{url('datapull/delete/'.$row->id)}}"><i class="fas fa-trash-alt"></i></a>
                                            </td>
