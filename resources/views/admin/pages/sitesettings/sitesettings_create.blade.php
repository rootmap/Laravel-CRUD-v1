            ...
            <div class="content add-details">
                <div class="in-content-wrapper">
                    <div class="box">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="breadcrumb">
                                            <div class="breadcrumb-item"><i class="fas fa-angle-right"></i><a href="{{url('sitesettings/list')}}"> Site Settings Data</a>
                                            </div>
                        ...
                        <div class="hotel-listing-form">
                            <form class="text-center" action="{{url('sitesettings')}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-row">
                            <div class="col-md">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="sitename" name="sitename" class="form-control" placeholder="Enter Site Name">
                                </div><!-- end form-group -->
                            </div><!-- end column -->
                        </div><!-- end form-row -->
