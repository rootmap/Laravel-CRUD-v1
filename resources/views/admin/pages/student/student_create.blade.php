            ...
            <div class="content add-details">
                <div class="in-content-wrapper">
                    <div class="box">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="breadcrumb">
                                            <div class="breadcrumb-item"><i class="fas fa-angle-right"></i><a href="{{url('student/list')}}"> Student Data</a>
                                            </div>
                        ...
                        <div class="hotel-listing-form">
                            <form class="text-center" action="{{url('student')}}" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                                <h4 class="input-group-text left">Address</h4>
