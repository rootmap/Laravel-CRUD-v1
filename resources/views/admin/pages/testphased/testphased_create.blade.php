            ...
            <div class="content add-details">
                <div class="in-content-wrapper">
                    <div class="box">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="breadcrumb">
                                            <div class="breadcrumb-item"><i class="fas fa-angle-right"></i><a href="{{url('testphased/list')}}"> Test Phased Data</a>
                                            </div>
                        ...
                        <div class="hotel-listing-form">
                            <form class="text-center" action="{{url('testphased')}}" method="post" enctype="multipart/form-data">
