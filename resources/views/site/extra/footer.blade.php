<div class="container">
      <div class="row">
        <div class="col-sm-6 col-md-3 col-xs-12">
          <div class="footer-logo"><a href="index.php"><img src="{{ url('site_theme/images/footer-logo.png')}}" alt="fotter logo"></a> </div>
        ...
        <div class="col-sm-6 col-md-3 col-xs-12 collapsed-block">
          <div class="footer-links">
            ...
            <div class="tabBlock" id="TabBlock-5">
              ...
              <div class="payment">
                <ul>
                  <li><a href="#"><img title="Visa" alt="Visa" src="{{ url('site_theme/images/visa.png')}}"></a></li>
                  <li><a href="#"><img title="Paypal" alt="Paypal" src="{{ url('site_theme/images/paypal.png')}}"></a></li>
                  <li><a href="#"><img title="Discover" alt="Discover" src="{{ url('site_theme/images/discover.png')}}"></a></li>
                  <li><a href="#"><img title="Master Card" alt="Master Card" src="{{ url('site_theme/images/master-card.png')}}"></a></li>
                </ul>
              </div>
            </div>
          </div>
