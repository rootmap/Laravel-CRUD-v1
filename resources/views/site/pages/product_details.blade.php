        ...
        <div class="col-main">
          <div class="product-view-area">
            <div class="product-big-image col-xs-12 col-sm-5 col-lg-5 col-md-5">
              ...
              <div class="large-image"><a href="{{ url('site_theme/images/product-1.jpg')}}" class="cloud-zoom" id="zoom1" rel="useWrapper: false, adjustY:0, adjustX:20"> <img class="zoom-img" src="{{url('site_theme/images/product-1.jpg')}}" alt="products"> </a> </div>
              <div class="flexslider flexslider-thumb">
                <ul class="previews-list slides">
                  <li><a href="{{url('site_theme/images/product-1.jpg')}}" class='cloud-zoom-gallery' rel="useZoom: 'zoom1', smallImage: '{{ url("site_theme/images/product-1.jpg")}}' "><img src="{{url('site_theme/images/product-1.jpg')}}" alt = "Thumbnail 2"/></a></li>
                  <li><a href="{{url('site_theme/images/product-1a.jpg')}}" class='cloud-zoom-gallery' rel="useZoom: 'zoom1', smallImage: '{{ url("site_theme/images/product-1a.jpg")}}' "><img src="{{url('site_theme/images/product-1a.jpg')}}" alt = "Thumbnail 1"/></a></li>
                  <li><a href="{{url('site_theme/images/product-1b.jpg')}}" class='cloud-zoom-gallery' rel="useZoom: 'zoom1', smallImage: '{{ url("site_theme/images/product-1b.jpg")}}' "><img src="{{url('site_theme/images/product-1b.jpg')}}" alt = "Thumbnail 1"/></a></li>
                  <li><a href="{{url('site_theme/images/product-1c.jpg')}}" class='cloud-zoom-gallery' rel="useZoom: 'zoom1', smallImage: '{{ url("site_theme/images/product-1c.jpg")}}' "><img src="{{url('site_theme/images/product-1c.jpg')}}" alt = "Thumbnail 2"/></a></li>
                  <li><a href="{{url('site_theme/images/product-1d.jpg')}}" class='cloud-zoom-gallery' rel="useZoom: 'zoom1', smallImage: '{{ url("site_theme/images/product-1d.jpg")}}' "><img src="{{url('site_theme/images/product-1d.jpg')}}" alt = "Thumbnail 2"/></a></li>
                </ul>
              </div>
                ...
                <div class="slider-items slider-width-col4 fadeInUp">
                    ...
                    <div class="item-inner">
                      <div class="product-thumbnail">
                        <div class="pr-img-area"> <a title="Product title here" href="single_product.php">
                          <figure> <img class="first-img" src="{{url('site_theme/images/product-11.jpg')}}" alt="HTML template"> <img class="hover-img" src="{{url('site_theme/images/product-6.jpg')}}" alt="HTML template"></figure>
                          </a> </div>
                  ...
                  <div class="product-item">
                    <div class="item-inner">
                      <div class="product-thumbnail">
                        ...
                        <div class="pr-img-area"> <a title="Product title here" href="single_product.php">
                          <figure> <img class="first-img" src="{{url('site_theme/images/product-15.jpg')}}" alt="HTML template"> <img class="hover-img" src="{{url('site_theme/images/product-3.jpg')}}" alt="HTML template"></figure>
                          </a> </div>
                        <div class="pr-info-area">
                          <div class="pr-button">
                            <div class="mt-button add_to_wishlist"><a href="wishlist.php"> <i class="fa fa-heart-o"></i> </a> </div>
                  ...
                  <div class="product-item">
                    <div class="item-inner">
                      <div class="product-thumbnail">
                        <div class="pr-img-area"> <a title="Product title here" href="single_product.php">
                          <figure> <img class="first-img" src="{{url('site_theme/images/product-17.jpg')}}" alt="HTML template"> <img class="hover-img" src="{{url('site_theme/images/product-4.jpg')}}" alt="HTML template"></figure>
                          </a> </div>
                        <div class="pr-info-area">
                          <div class="pr-button">
                            <div class="mt-button add_to_wishlist"><a href="wishlist.php"> <i class="fa fa-heart-o"></i> </a> </div>
                  ...
                  <div class="product-item">
                    <div class="item-inner">
                      <div class="product-thumbnail">
                        <div class="pr-img-area"> <a title="Product title here" href="single_product.php">
                          <figure> <img class="first-img" src="{{url('site_theme/images/product-11.jpg')}}" alt="HTML template"> <img class="hover-img" src="{{url('site_theme/images/product-5.jpg')}}" alt="HTML template"></figure>
                          </a> </div>
                        <div class="pr-info-area">
                          <div class="pr-button">
                            <div class="mt-button add_to_wishlist"><a href="wishlist.php"> <i class="fa fa-heart-o"></i> </a> </div>
                  ...
                  <div class="product-item">
                    <div class="item-inner">
                      <div class="product-thumbnail">
                        <div class="pr-img-area"> <a title="Product title here" href="single_product.php">
                          <figure> <img class="first-img" src="{{url('site_theme/images/product-8.jpg')}}" alt="HTML template"> <img class="hover-img" src="{{url('site_theme/images/product-2.jpg')}}" alt="HTML template"></figure>
                          </a> </div>
                        <div class="pr-info-area">
                          <div class="pr-button">
                            <div class="mt-button add_to_wishlist"><a href="wishlist.php"> <i class="fa fa-heart-o"></i> </a> </div>
                  ...
                  <div class="product-item">
                    <div class="item-inner">
                      <div class="product-thumbnail">
                        <div class="pr-img-area"> <a title="Product title here" href="single_product.php">
                          <figure> <img class="first-img" src="{{url('site_theme/images/product-13.jpg')}}" alt="HTML template"> <img class="hover-img" src="{{url('site_theme/images/product-4.jpg')}}" alt="HTML template"></figure>
                          </a> </div>
                        <div class="pr-info-area">
                          <div class="pr-button">
                            <div class="mt-button add_to_wishlist"><a href="wishlist.php"> <i class="fa fa-heart-o"></i> </a> </div>
                  ...
                  <div class="product-item">
                    <div class="item-inner">
                      <div class="product-thumbnail">
                        <div class="pr-img-area"> <a title="Product title here" href="single_product.php">
                          <figure> <img class="first-img" src="{{url('site_theme/images/product-15.jpg')}}" alt="HTML template"> <img class="hover-img" src="{{url('site_theme/images/product-8.jpg')}}" alt="HTML template"></figure>
                          </a> </div>
                        <div class="pr-info-area">
                          <div class="pr-button">
                            <div class="mt-button add_to_wishlist"><a href="wishlist.php"> <i class="fa fa-heart-o"></i> </a> </div>
                  ...
                  <div class="product-item">
                    <div class="item-inner">
                      <div class="product-thumbnail">
                        <div class="pr-img-area"> <a title="Product title here" href="single_product.php">
                          <figure> <img class="first-img" src="{{url('site_theme/images/product-16.jpg')}}" alt="HTML template"> <img class="hover-img" src="{{url('site_theme/images/product-6.jpg')}}" alt="HTML template"></figure>
                          </a> </div>
                        <div class="pr-info-area">
                          <div class="pr-button">
                            <div class="mt-button add_to_wishlist"><a href="wishlist.php"> <i class="fa fa-heart-o"></i> </a> </div>
              ...
              <div class="slider-items slider-width-col4">
                ...
                <div class="product-item">
                  <div class="item-inner">
                    <div class="product-thumbnail">
                      <div class="icon-sale-label sale-left">Sale</div>
                      <div class="pr-img-area"> <a title="Product title here" href="single_product.php">
                        <figure> <img class="first-img" src="{{url('site_theme/images/product-12.jpg')}}" alt="HTML template"> <img class="hover-img" src="{{url('site_theme/images/product-9.jpg')}}" alt="HTML template"></figure>
                        </a> </div>
                      <div class="pr-info-area">
                        <div class="pr-button">
                          <div class="mt-button add_to_wishlist"><a href="wishlist.php"> <i class="fa fa-heart-o"></i> </a> </div>
                ...
                <div class="product-item">
                  <div class="item-inner">
                    <div class="product-thumbnail">
                      ...
                      <div class="icon-new-label new-right">New</div>
                      <div class="pr-img-area"> <a title="Product title here" href="single_product.php">
                        <figure> <img class="first-img" src="{{url('site_theme/images/product-10.jpg')}}" alt="HTML template"> <img class="hover-img" src="{{url('site_theme/images/product-16.jpg')}}" alt="HTML template"></figure>
                        </a> </div>
                      <div class="pr-info-area">
                        <div class="pr-button">
                          <div class="mt-button add_to_wishlist"><a href="wishlist.php"> <i class="fa fa-heart-o"></i> </a> </div>
                ...
                <div class="product-item">
                  <div class="item-inner">
                    <div class="product-thumbnail">
                      <div class="pr-img-area"> <a title="Product title here" href="single_product.php">
                        <figure> <img class="first-img" src="{{url('site_theme/images/product-11.jpg')}}" alt="HTML template"> <img class="hover-img" src="{{url('site_theme/images/product-4.jpg')}}" alt="HTML template"></figure>
                        </a> </div>
                      <div class="pr-info-area">
                        <div class="pr-button">
                          <div class="mt-button add_to_wishlist"><a href="wishlist.php"> <i class="fa fa-heart-o"></i> </a> </div>
...
@section('js')
<!--cloud-zoom js --> 
<script src="{{ url('site_theme/js/cloud-zoom.js') }}"></script> 
<!-- flexslider js --> 
<script src="{{ url('site_theme/js/jquery.flexslider.js') }}"></script> 
@endsection